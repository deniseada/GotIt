                ...
                <div className={styles.toolbarInner}>
                    ...
                    <div className={styles.toolbarCenter}>
                            ...
                            <div className={styles.zoomGroup} role="group" aria-label="Zoom controls">
                                ...
                                <button className={styles.toolButton} onClick={onZoomOut} title="Zoom out">
                                    <ZoomOutIcon className={styles.toolbarSvg} />
                                    <span className={styles.srOnly}>Zoom out</span>
                                </button>
                                <button className={styles.toolButton} onClick={onZoomReset} title="Reset zoom">
                                    <RestartAltIcon className={styles.toolbarSvg} />
                                    <span className={styles.srOnly}>Reset zoom</span>
                                </button>
                                <button className={styles.toolButton} onClick={onZoomIn} title="Zoom in">
