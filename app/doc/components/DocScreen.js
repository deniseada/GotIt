    ...
    >
        ...
        <>
          <div>
            ...
            <ul>
              ...
              <li>
                The three principal parts of an atom are the proton, the
                electron, and the neutron.
              </li>
              <li>
                Protons have a positive charge, electrons a negative charge, and
                neutrons no charge.
              </li>
              <li>
              ...
              <li>
                Conductors are materials that provide an easy path for electron
                flow.
              </li>
              <li>
                Conductors are made from materials that contain from one to
                three valence electrons.
              </li>
              <li>
                Insulators are materials that do not provide an easy path for
                the flow of electrons.
              </li>
              <li>
                Insulators are generally made from materials containing seven or
            ...
            <ul>
              ...
              <li>
                Proton: A positively charged particle located in the nucleus of
                an atom.
              </li>
              <li>
              ...
              <li>
                Neutron: A particle with no charge that is located in the
                nucleus of an atom.
              </li>
              <li>
                Valence electrons: Electrons located in the outer orbit of an
                atom.
              </li>
              <li>
                Conductor: A material that provides an easy path for electron
                flow.
              </li>
              <li>
                Insulator: A material that does not provide an easy path for the
                flow of electrons.
              </li>
            </ul>
          </div>
      ...
      {mode === "summarized" && (
        <div>
          <b>Summary:</b>
          <p>
            Delmar - Section 1 introduces the concept of electricity, its
            history, and its importance in modern life. It explains the basic
            principles of electricity, including voltage, current, and
            resistance, and how they relate to Ohm's Law. The section also
            covers different types of circuits, including series and parallel,
            and the role of components like resistors, capacitors, and
            inductors. It discusses power in electrical circuits, both in terms
            of instantaneous and average power, and introduces the concept of
            electrical energy. The section also touches on electrical safety and
            the use of circuit breakers and fuses. Lastly, it provides an
            overview of electrical systems in homes and buildings, including the
            electrical service entrance, service panel, and branch circuits.
          </p>
          <Summarization
            text={summary}
...
const ColorPickerMenu = React.memo(function ColorPickerMenu({
  onDone,
  onCancel,
  initialColor,
}) {
